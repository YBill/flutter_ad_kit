...
class BannerAdDelegate extends BaseAdDelegate {
  BannerAdDelegate(AdSource adSource, String adUnitId, this._adSize, AdEventController eventController, BaseAdConfig adConfig)
      : super(adSource, AdType.banner, adUnitId, eventController, adConfig);
